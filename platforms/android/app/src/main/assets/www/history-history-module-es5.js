...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["history-history-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppSidemenuHistoryHistoryPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSidemenuHistoryHistoryModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSidemenuHistoryHistoryPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSidemenuHistoryHistoryPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var HistoryPage = /*#__PURE__*/function () {
      function HistoryPage(translateConfigService, http, datepipe, platform, changeRef, navCtrl, translate) {
        ...
        this.Page = 20; //alert('constructor call');
      ...
      _createClass(HistoryPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.platform.ready().then(function () {
            ...
            _this.translate.get('History').subscribe(function (res) {
              _this.heading = "";
              _this.heading = res;

              _this.GetCheckInData();
            });
          });
        }
      }, {
        key: "GetInfinityPageData",
        value: function GetInfinityPageData(event, page) {
          // this.result = [];
        ...
        value: function GetCheckInData() {
          ...
          this.platform.ready().then(function () {
            ...
            console.log("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl, "/api/check_in_out_view"), JSON.stringify(_this2.data));

            _this2.http.post("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl, "/api/check_in_out_view"), _this2.data, headers).then(function (res) {
              console.log("Check In Data:-", JSON.parse(res.data));
              _this2.result = [];
              _this2.result = JSON.parse(res.data);
              var temp;
              temp = [];
              temp = JSON.parse(res.data);
              _this2.result = [];
              _this2.result = temp.checkInOutData;
              console.log('this.result.length' + JSON.stringify(_this2.result));

              if (_this2.result.length > 0) {
                _this2.historyData = [];

                for (var i = 0; i < _this2.Page; i++) {
                  var date = "";

                  if (_this2.result[i]["check_out_date_time"] == null) {
                    date = _this2.utcdateToLocal(_this2.result[i]["check_in_date_time"]);

                    var tempStatus = _this2.langTransalate('Arrival');

                    _this2.historyData.push({
                      "id": _this2.result[i]["id"],
                      "citizenID": _this2.result[i]["citizen_id"],
                      "Name": _this2.result[i]["firstname"] + " " + _this2.result[i]["lastname"],
                      "checkindate": date,
                      "arrival": tempStatus
                    });
                  } else {
                    if (_this2.result[i]["check_in_date_time"] != null) {
                      date = _this2.utcdateToLocal(_this2.result[i]["check_in_date_time"]);
                      ...
                      if (_this2.result[i]["check_in_date_time"] != null) {
                        date = _this2.utcdateToLocal(_this2.result[i]["check_out_date_time"]);

                        var tempStatus = _this2.langTransalate('Departure');
              ...
              console.log('this.historyData' + JSON.stringify(_this2.historyData));
            })["catch"](function (err) {
        ...
        value: function loadData(event) {
          ...
          setTimeout(function () {
            console.log('Done');
            console.log('this.len', _this3.Page); // App logic to determine if all data is loaded
            // and disable the infinite scroll

            if (_this3.Page > _this3.result.length) //21>=20
              {
                console.log('this.page return', _this3.Page);
                event.target.disabled = true;
                return false;
              } else {
              _this3.GetInfinityPageData(event, _this3.Page);
        ...
        value: function ionViewWillEnter() {
          ...
          this.GetCheckInData(); //this.navCtrl.navigateForward(['tablinks/'+localStorage.getItem('selectedtabs')]);
        }
      }, {
        key: "langTransalate",
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)], HistoryPage.prototype, "heading", void 0);
    HistoryPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/sidemenu/history/history.page.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./history.page.scss */
      "./src/app/sidemenu/history/history.page.scss"))["default"]]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_translate_config_service__WEBPACK_IMPORTED_MODULE_6__["TranslateConfigService"], _ionic_native_http_ngx__WEBPACK_IMPORTED_MODULE_2__["HTTP"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["DatePipe"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["NavController"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_7__["TranslateService"]])], HistoryPage);
    /***/
  }
}]);

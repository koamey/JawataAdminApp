...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["scanpage-scanpage-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppSidemenuScanpageScanpagePageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSidemenuScanpageScanpageModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ScanpagePageModule", function () {
      return ScanpagePageModule;
    });
    /* harmony import */
    ...
    var _scanpage_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./scanpage.page */
    ...
    var ScanpagePageModule = function ScanpagePageModule() {
      _classCallCheck(this, ScanpagePageModule);
    };

    ScanpagePageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppSidemenuScanpageScanpagePageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSidemenuScanpageScanpagePageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ScanpagePage", function () {
      return ScanpagePage;
    });
    /* harmony import */
    ...
    var src_app_translate_config_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! src/app/translate-config.service */
    "./src/app/translate-config.service.ts");
    /* harmony import */
    ...
    var ScanpagePage = /*#__PURE__*/function () {
      function ScanpagePage(barcodeScanner, translateConfigService, http, datepipe, platform, popoverCtrl, vibration, translate, alertCtrl) {
        _classCallCheck(this, ScanpagePage);
      ...
      _createClass(ScanpagePage, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this = this;

          this.platform.ready().then(function () {
            _this.translate.use(_this.selectedLanguage);

            _this.translate.get('Scan').subscribe(function (res) {
              _this.heading = "";
              _this.heading = res;
            });

            console.log('selected Language' + _this.selectedLanguage);
            ...
            _this.checkdefaultsettings(); //this.GetCheckInData();
        ...
        key: "checkdefaultsettings",
        value: function checkdefaultsettings() {
        ...
        value: function scanBarcode() {
          ...
          this.barcodeScanner.scan(this.options).then(function (barcodeData) {
            ...
            _this2.scannedData = barcodeData; //let dateTime = this.datepipe.transform(new Date(), 'yyyy-MM-dd HH-mm-ss');
            ...
            if (barcodeData.text != "") {
              console.log("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl, "/api/check_in"), JSON.stringify(_this2.data));

              _this2.http.post("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl, "/api/check_in"), _this2.data, headers).then(function (res) {
                            ...
                            buttons: [{
                              ...
                              handler: function handler() {
                                if (localStorage.getItem('scanActionID') == '0') {
                                  if (barcodeData.cancelled == true) return false;else _this3.scanBarcode();
                                }
                              }
                            }]
                          });
    ...
    ScanpagePage.ctorParameters = function () {
      return [{
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)], ScanpagePage.prototype, "heading", void 0);
    ScanpagePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-scanpage',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./scanpage.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/sidemenu/scanpage/scanpage.page.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./scanpage.page.scss */
      "./src/app/sidemenu/scanpage/scanpage.page.scss"))["default"]]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_native_barcode_scanner_ngx__WEBPACK_IMPORTED_MODULE_2__["BarcodeScanner"], src_app_translate_config_service__WEBPACK_IMPORTED_MODULE_8__["TranslateConfigService"], _ionic_native_http_ngx__WEBPACK_IMPORTED_MODULE_3__["HTTP"], _angular_common__WEBPACK_IMPORTED_MODULE_6__["DatePipe"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["Platform"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["PopoverController"], _ionic_native_vibration_ngx__WEBPACK_IMPORTED_MODULE_7__["Vibration"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_9__["TranslateService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["AlertController"]])], ScanpagePage);
    /***/
  }
}]);
//# sourceMappingURL=scanpage-scanpage-module-es5.js.map